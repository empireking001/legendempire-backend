      ...
      const cats = [
        {
          name: "Scholarships",
          slug: "scholarships",
          description: "Fully funded & partial scholarships worldwide",
          color: "#6366f1",
          icon: "🎓",
          order: 1,
        },
        {
          name: "Jobs",
          slug: "jobs",
          description: "Remote jobs and career opportunities",
          color: "#10b981",
          icon: "💼",
          order: 2,
        },
        {
          name: "Technology",
          slug: "technology",
          description: "Tech news, tools, and tutorials",
          color: "#f59e0b",
          icon: "💻",
          order: 3,
        },
        {
          name: "Money",
          slug: "money",
          description: "Finance, investing, and wealth tips",
          color: "#ef4444",
          icon: "💰",
          order: 4,
        },
        {
          name: "Education",
          slug: "education",
          description: "Learning resources and academic guides",
          color: "#8b5cf6",
          icon: "📚",
          order: 5,
        },
